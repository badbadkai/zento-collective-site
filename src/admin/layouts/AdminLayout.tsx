...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Sidebar */}
      <aside
        className={`border-r border-border/50 bg-card/30 flex flex-col shrink-0 transition-all duration-300 ease-in-out ${
          collapsed ? "w-16" : "w-64"
        }`}
      >
        {/* Header */}
      ...
      {/* Main content — centred in the full remaining space */}
