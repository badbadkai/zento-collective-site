  ...
  return <section className="section-spacing bg-card/50">
      <div className="container-studio">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">Join a community of traders applying our frameworks to refine process control and reduce behavioral variance.</p>
        </div>

        <div className="max-w-2xl mx-auto mb-12">
          {channels.map((channel, index) => <div key={index} className="flex items-start gap-4 p-6 mb-4 rounded-lg bg-background border border-border animate-fade-in" style={{
